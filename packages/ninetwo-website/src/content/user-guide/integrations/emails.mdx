...
Internal emails are emails between two people in the same organization. We consider an email to be internal when every participant shares the same domain: _from_, _to_, _cc_ and _bcc_. **Internal emails are not synced to the CRM.**
...
<img
  src="/images/user-guide/emails/connect-account.png"
  style={{ width: '100%' }}
/>
...
<img
  src="/images/user-guide/emails/privacy-settings.png"
  style={{ width: '100%' }}
/>
...
<img
  src="/images/user-guide/emails/auto-creation.png"
  style={{ width: '100%' }}
/>
