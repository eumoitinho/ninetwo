...
- **Batch operations** are available with the GraphQL APIs. You just need to use the plural name of your object.  
  _Example_: use the mutation `CreateCompanies` instead of `CreateCompany` for your batch creation.
  _(This is the reason why the singular and plural names of your object needs to be distinct.)_
...
<ArticleWarning>
  Since your API key gives access to sensitive information, you shouldn't share
  it with services you don't fully trust. If leaked, someone can use it
  maliciously. If your API key's security is compromised, immediately disable it
