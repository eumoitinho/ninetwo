...
<ArticlePropsTable
  options={[
    ...
    [
      'position',
      'string',
      'The position of the button in relation to its siblings. Options include: `standalone`, `left`, `middle`, `right`',
      '',
    ],
    [
      'applyShadow',
      'boolean',
      'Determines whether to apply shadow to a button',
      '`true`',
    ],
    [
      'applyBlur',
      'boolean',
      'Determines whether to apply a blur effect to the button',
      '`true`',
    ],
    [
      'disabled',
...
<ArticlePropsTable
  options={[
    ...
    [
      'variant',
      'string',
      'The visual style variant of the button. Options include `primary` and `secondary`',
      'primary',
    ],
    [
      'soon',
