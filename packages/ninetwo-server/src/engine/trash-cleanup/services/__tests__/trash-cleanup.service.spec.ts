...
describe('TrashCleanupService', () => {
  ...
  let mockNinetwoORMGlobalManager: any;
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        },
        {
          ...
          useValue: mockNinetwoORMGlobalManager,
        },
      ],
    }).compile();
  ...
  describe('cleanupWorkspaceTrash', () => {
    ...
    it('should return deleted count when cleanup succeeds', async () => {
      ...
      mockNinetwoORMGlobalManager.getRepositoryForWorkspace
    ...
    it('should ignore objects without soft deleted records', async () => {
      ...
      mockNinetwoORMGlobalManager.getRepositoryForWorkspace.mockResolvedValueOnce(
        companyRepository,
      );
