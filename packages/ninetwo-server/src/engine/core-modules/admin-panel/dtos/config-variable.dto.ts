...
import { ConfigVariableValue } from 'ninetwo-shared/types';
...
import { ConfigVariableOptions } from 'src/engine/core-modules/ninetwo-config/types/config-variable-options.type';
