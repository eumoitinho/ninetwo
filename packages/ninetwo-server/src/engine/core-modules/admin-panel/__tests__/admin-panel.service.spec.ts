...
const NinetwoConfigServiceGetAllMock = jest.fn();
const NinetwoConfigServiceGetVariableWithMetadataMock = jest.fn();

jest.mock(
  'src/engine/core-modules/ninetwo-config/constants/config-variables-group-metadata',
  () => ({
...
describe('AdminPanelService', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        },
        {
          ...
          useValue: {
            getAll: NinetwoConfigServiceGetAllMock,
            getVariableWithMetadata:
              NinetwoConfigServiceGetVariableWithMetadataMock,
          },
        },
        {
  ...
  describe('getConfigVariablesGrouped', () => {
    it('should correctly group and sort config variables', () => {
      NinetwoConfigServiceGetAllMock.mockReturnValue({
        SERVER_URL: {
  ...
  describe('getConfigVariable', () => {
    it('should return config variable with all fields', () => {
      NinetwoConfigServiceGetVariableWithMetadataMock.mockReturnValue({
        value: 'test-value',
        metadata: {
          group: 'SERVER_CONFIG',
    ...
    it('should throw error when variable not found', () => {
      NinetwoConfigServiceGetVariableWithMetadataMock.mockReturnValue(undefined);
