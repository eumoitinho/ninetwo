...
import { configTransformers } from 'src/engine/core-modules/ninetwo-config/utils/config-transformers.util';
...
jest.mock(
  'src/engine/core-modules/ninetwo-config/utils/config-transformers.util',
  () => ({
    configTransformers: {
      boolean: jest.fn(),
      number: jest.fn(),
...
describe('applyBasicValidators', () => {
  ...
  describe('enum type', () => {
    ...
    it('should apply enum validator with enum object options', () => {
      ...
      jest.mock(
        'src/engine/core-modules/ninetwo-config/utils/type-transformers.registry',
        () => ({
          typeTransformers: {
            enum: {
