...
import { NodeEnvironment } from 'src/engine/core-modules/ninetwo-config/interfaces/node-environment.interface';

import { ConfigVariables } from 'src/engine/core-modules/ninetwo-config/config-variables';
import { CONFIG_VARIABLES_MASKING_CONFIG } from 'src/engine/core-modules/ninetwo-config/constants/config-variables-masking-config';
import { type ConfigVariablesMetadataOptions } from 'src/engine/core-modules/ninetwo-config/decorators/config-variables-metadata.decorator';
import { DatabaseConfigDriver } from 'src/engine/core-modules/ninetwo-config/drivers/database-config.driver';
import { EnvironmentConfigDriver } from 'src/engine/core-modules/ninetwo-config/drivers/environment-config.driver';
import { ConfigSource } from 'src/engine/core-modules/ninetwo-config/enums/config-source.enum';
import { ConfigVariablesMaskingStrategies } from 'src/engine/core-modules/ninetwo-config/enums/config-variables-masking-strategies.enum';
import {
  ConfigVariableException,
  ConfigVariableExceptionCode,
} from 'src/engine/core-modules/ninetwo-config/ninetwo-config.exception';
import { configVariableMaskSensitiveData } from 'src/engine/core-modules/ninetwo-config/utils/config-variable-mask-sensitive-data.util';
import { isEnvOnlyConfigVar } from 'src/engine/core-modules/ninetwo-config/utils/is-env-only-config-var.util';
import { TypedReflect } from 'src/utils/typed-reflect';

@Injectable()
export class NinetwoConfigService {
  private readonly logger = new Logger(NinetwoConfigService.name);
