...
import { FIELD_RESTRICTED_ADDITIONAL_PERMISSIONS_REQUIRED } from 'ninetwo-shared/constants';
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: NinetwoORMManager,
          useValue: mockNinetwoORMManager,
        },
      ],
    }).compile();
