...
import { NinetwoORMExceptionCode } from 'src/engine/ninetwo-orm/exceptions/ninetwo-orm.exception';
    ...
    return this.getRolesPermissionsFromCacheWithRecomputeService.getFromCacheWithRecompute(
      {
        ...
        exceptionCode:
          NinetwoORMExceptionCode.ROLES_PERMISSIONS_VERSION_NOT_FOUND,
      },
    );
  }
    ...
    return this.getUserWorkspaceRoleMapFromCacheWithRecomputeService.getFromCacheWithRecompute(
      {
        ...
        exceptionCode:
          NinetwoORMExceptionCode.USER_WORKSPACE_ROLE_MAP_VERSION_NOT_FOUND,
      },
    );
  }
    ...
    return this.getApiKeyRoleMapFromCacheWithRecomputeService.getFromCacheWithRecompute(
      {
        ...
        exceptionCode:
          NinetwoORMExceptionCode.API_KEY_ROLE_MAP_VERSION_NOT_FOUND,
      },
    );
  }
