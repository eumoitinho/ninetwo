import { type RestrictedFieldsPermissions } from 'ninetwo-shared/types';
import { isDefined } from 'ninetwo-shared/utils';

import { type ObjectMetadataItemWithFieldMaps } from 'src/engine/metadata-modules/types/object-metadata-item-with-field-maps';
import { getFieldMetadataIdToColumnNamesMap } from 'src/engine/ninetwo-orm/utils/get-field-metadata-id-to-column-names-map.util';
