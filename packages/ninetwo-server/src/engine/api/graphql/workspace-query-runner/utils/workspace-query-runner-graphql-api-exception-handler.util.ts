...
import { NinetwoORMException } from 'src/engine/ninetwo-orm/exceptions/ninetwo-orm.exception';
import { twentyORMGraphqlApiExceptionHandler } from 'src/engine/ninetwo-orm/utils/ninetwo-orm-graphql-api-exception-handler.util';
...
export const workspaceQueryRunnerGraphqlApiExceptionHandler = (
  ...
  switch (true) {
    ...
    case error instanceof NinetwoORMException:
