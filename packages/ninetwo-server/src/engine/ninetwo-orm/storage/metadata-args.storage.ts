import { type WorkspaceDynamicRelationMetadataArgs } from 'src/engine/ninetwo-orm/interfaces/workspace-dynamic-relation-metadata-args.interface';
import { type WorkspaceEntityMetadataArgs } from 'src/engine/ninetwo-orm/interfaces/workspace-entity-metadata-args.interface';
import { type WorkspaceExtendedEntityMetadataArgs } from 'src/engine/ninetwo-orm/interfaces/workspace-extended-entity-metadata-args.interface';
import { type WorkspaceFieldMetadataArgs } from 'src/engine/ninetwo-orm/interfaces/workspace-field-metadata-args.interface';
import { type WorkspaceIndexMetadataArgs } from 'src/engine/ninetwo-orm/interfaces/workspace-index-metadata-args.interface';
import { type WorkspaceJoinColumnsMetadataArgs } from 'src/engine/ninetwo-orm/interfaces/workspace-join-columns-metadata-args.interface';
import { type WorkspaceRelationMetadataArgs } from 'src/engine/ninetwo-orm/interfaces/workspace-relation-metadata-args.interface';
