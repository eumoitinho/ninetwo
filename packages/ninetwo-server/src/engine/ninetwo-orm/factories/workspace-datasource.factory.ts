...
import { type ObjectsPermissionsByRoleId } from 'ninetwo-shared/types';
...
import { WorkspaceDataSource } from 'src/engine/ninetwo-orm/datasource/workspace.datasource';
import {
  NinetwoORMException,
...
import { PromiseMemoizer } from 'src/engine/ninetwo-orm/storage/promise-memoizer.storage';
import { type CacheKey } from 'src/engine/ninetwo-orm/storage/types/cache-key.type';
...
export class WorkspaceDatasourceFactory {
        ...
        async () => {
          ...
          if (!dataSourceMetadata) {
            throw new NinetwoORMException(
              ...
              NinetwoORMExceptionCode.WORKSPACE_SCHEMA_NOT_FOUND,
            );
          }
          ...
          if (
            ...
            throw new NinetwoORMException(
              ...
              NinetwoORMExceptionCode.METADATA_VERSION_MISMATCH,
            );
          }
  ...
  private async getRolesPermissionsFromCache({
    ...
    return this.getFromCacheWithRecomputeService.getFromCacheWithRecompute({
      ...
      exceptionCode: NinetwoORMExceptionCode.ROLES_PERMISSIONS_VERSION_NOT_FOUND,
    });
  }
  ...
  private async getWorkspaceMetadataVersionFromCacheOrFromDB(
    ...
    if (!workspace) {
      throw new NinetwoORMException(
        ...
        NinetwoORMExceptionCode.WORKSPACE_NOT_FOUND,
      );
    }
