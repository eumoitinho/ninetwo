...
import { type RelationDisconnectQueryFieldsByEntityIndex } from 'src/engine/ninetwo-orm/entity-manager/types/relation-nested-query-fields-by-entity-index.type';
...
> extends InsertQueryBuilder<T> {
  ...
  override async execute(): Promise<InsertResult> {
    try {
      ...
      throw computeNinetwoORMException(error, objectMetadata);
    }
  }
