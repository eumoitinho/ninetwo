...
import { type DeepPartialWithNestedRelationFields } from 'src/engine/ninetwo-orm/entity-manager/types/deep-partial-entity-with-nested-relation-fields.type';
...
import { getEntityTarget } from 'src/engine/ninetwo-orm/entity-manager/utils/get-entity-target';
import { computeNinetwoORMException } from 'src/engine/ninetwo-orm/error-handling/compute-ninetwo-orm-exception';
import { RelationNestedQueries } from 'src/engine/ninetwo-orm/relation-nested-queries/relation-nested-queries';
import {
  type OperationType,
  validateOperationIsPermittedOrThrow,
} from 'src/engine/ninetwo-orm/repository/permissions.utils';
import { WorkspaceSelectQueryBuilder } from 'src/engine/ninetwo-orm/repository/workspace-select-query-builder';
import { WorkspaceRepository } from 'src/engine/ninetwo-orm/repository/workspace.repository';
import { type RolePermissionConfig } from 'src/engine/ninetwo-orm/types/role-permission-config';
import { computePermissionIntersection } from 'src/engine/ninetwo-orm/utils/compute-permission-intersection.util';
import { formatData } from 'src/engine/ninetwo-orm/utils/format-data.util';
...
export class WorkspaceEntityManager extends EntityManager {
  ...
  >(
    ...
    try {
      ...
      throw computeNinetwoORMException(error, objectMetadataItem);
    }
  }
