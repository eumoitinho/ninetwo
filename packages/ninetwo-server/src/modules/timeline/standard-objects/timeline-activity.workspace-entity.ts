...
import { CustomWorkspaceEntity } from 'src/engine/ninetwo-orm/custom.workspace-entity';
import { WorkspaceDynamicRelation } from 'src/engine/ninetwo-orm/decorators/workspace-dynamic-relation.decorator';
...
import { WorkspaceGate } from 'src/engine/ninetwo-orm/decorators/workspace-gate.decorator';
...
export class TimelineActivityWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  @WorkspaceRelation({
    standardId: TIMELINE_ACTIVITY_STANDARD_FIELD_IDS.adsCampaign,
    type: RelationType.MANY_TO_ONE,
    label: msg`Ads Campaign`,
    description: msg`Event Ads Campaign`,
    icon: 'IconTargetArrow',
  ...
  @WorkspaceIsNullable()
  adsCampaign: Relation<AdsCampaignWorkspaceEntity> | null;

  @WorkspaceJoinColumn('adsCampaign')
  adsCampaignId: string | null;
