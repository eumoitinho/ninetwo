...
export class ConnectedAccountWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  @WorkspaceField({
    standardId: CONNECTED_ACCOUNT_STANDARD_FIELD_IDS.syncConfig,
    type: FieldMetadataType.RAW_JSON,
    label: msg`Sync Configuration`,
    description: msg`JSON object containing sync configuration for marketing platforms`,
    icon: 'IconSettings',
  })
  @WorkspaceIsNullable()
