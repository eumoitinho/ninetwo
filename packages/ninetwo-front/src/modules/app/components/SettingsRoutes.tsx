...
const SettingsIntegrationsMarketing = lazy(() =>
  import('~/pages/settings/integrations/SettingsIntegrationsMarketing').then(
    (module) => ({
      default: module.SettingsIntegrationsMarketing,
    }),
  ),
);

const SettingsIntegrationsMarketingGoogleAdsConfigure = lazy(() =>
  import(
    '~/pages/settings/integrations/SettingsIntegrationsMarketingGoogleAdsConfigure'
  ).then((module) => ({
    default: module.SettingsIntegrationsMarketingGoogleAdsConfigure,
  })),
);

const SettingsIntegrationsMarketingGoogleAnalyticsConfigure = lazy(() =>
  import(
    '~/pages/settings/integrations/SettingsIntegrationsMarketingGoogleAnalyticsConfigure'
  ).then((module) => ({
    default: module.SettingsIntegrationsMarketingGoogleAnalyticsConfigure,
  })),
);
