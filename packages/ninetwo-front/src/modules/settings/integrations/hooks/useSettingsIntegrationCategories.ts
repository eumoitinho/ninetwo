...
import { SETTINGS_INTEGRATION_MARKETING_CATEGORY } from '@/settings/integrations/constants/SettingsIntegrationMarketing';
...
export const useSettingsIntegrationCategories =
  (): SettingsIntegrationCategory[] => {
    ...
    return [
      ...
      SETTINGS_INTEGRATION_MARKETING_CATEGORY,
