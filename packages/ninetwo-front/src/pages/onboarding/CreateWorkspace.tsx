...
import { MainButton } from 'ninetwo-ui/input';
  ...
  return (
    <Modal.Content isVerticalCentered isHorizontalCentered>
      ...
      {pendingCreationLoaderStep === PendingCreationLoaderStep.None && (
        <>
          <Title noMarginTop>
            <Trans>Crie seu workspace</Trans>
          </Title>
          <SubTitle>
            <Trans>
              Um ambiente compartilhado onde você poderá gerenciar suas relações
              com clientes junto com sua equipe.
            </Trans>
          </SubTitle>

          <StyledContentContainer>
            <StyledSectionContainer>
              <H2Title title={t`Logo do workspace`} />
              <WorkspaceLogoUploader />
            </StyledSectionContainer>
            <StyledSectionContainer>
              <H2Title
                title={t`Nome do workspace`}
                description={t`O nome da sua organização`}
              />
              <Controller
                name="name"
                control={control}
                render={({
                  ...
                  <TextInput
                    autoFocus
                    value={value}
                    placeholder="NineTwo Performance"
                    onBlur={onBlur}
                    onChange={onChange}
                    error={error?.message}
