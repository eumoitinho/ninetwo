...
export type ConfigureMarketingAdAccountsMutationVariables = Exact<{
  connectedAccountId: Scalars['UUID'];
  customerIds: Array<Scalars['String']> | Scalars['String'];
  managerCustomerId?: InputMaybe<Scalars['String']>;
}>;


export type ConfigureMarketingAdAccountsMutation = { __typename?: 'Mutation', configureMarketingAdAccounts: boolean };

export type ConfigureMarketingAnalyticsAccountsMutationVariables = Exact<{
  connectedAccountId: Scalars['UUID'];
  propertyIds: Array<Scalars['String']> | Scalars['String'];
}>;


export type ConfigureMarketingAnalyticsAccountsMutation = { __typename?: 'Mutation', configureMarketingAnalyticsAccounts: boolean };

export type GetMarketingAdAccountsQueryVariables = Exact<{
  connectedAccountId: Scalars['UUID'];
}>;


export type GetMarketingAdAccountsQuery = { __typename?: 'Query', getMarketingAdAccounts: { __typename?: 'AdAccountsResultDto', managerAccountId?: string | null, selectedAccounts: Array<string>, accounts: Array<{ __typename?: 'AdAccountDto', id: string, name: string, type?: string | null, platform?: string | null, currencyCode?: string | null, timezone?: string | null }> } };

export type GetMarketingAnalyticsAccountsQueryVariables = Exact<{
  connectedAccountId: Scalars['UUID'];
}>;


export type GetMarketingAnalyticsAccountsQuery = { __typename?: 'Query', getMarketingAnalyticsAccounts: { __typename?: 'AdAccountsResultDto', selectedAccounts: Array<string>, accounts: Array<{ __typename?: 'AdAccountDto', id: string, name: string, type?: string | null, platform?: string | null }> } };

export type GetMarketingCampaignsQueryVariables = Exact<{
  connectedAccountId: Scalars['UUID'];
  customerId: Scalars['String'];
  managerCustomerId?: InputMaybe<Scalars['String']>;
}>;
...
export type GetMarketingCampaignsQuery = { __typename?: 'Query', getMarketingCampaigns: Array<{ __typename?: 'MarketingCampaignDto', id: string, name: string, platform?: string | null, externalId?: string | null, status: string, dailyBudget?: number | null, totalBudget?: number | null, currencyCode?: string | null, connectedAccountId?: string | null }> };

export type PauseMarketingCampaignMutationVariables = Exact<{
  connectedAccountId: Scalars['UUID'];
  customerId: Scalars['String'];
  campaignId: Scalars['String'];
  managerCustomerId?: InputMaybe<Scalars['String']>;
...
export type PauseMarketingCampaignMutation = { __typename?: 'Mutation', pauseMarketingCampaign: boolean };

export type ActivateMarketingCampaignMutationVariables = Exact<{
  connectedAccountId: Scalars['UUID'];
  customerId: Scalars['String'];
  campaignId: Scalars['String'];
  managerCustomerId?: InputMaybe<Scalars['String']>;
...
export type ActivateMarketingCampaignMutation = { __typename?: 'Mutation', activateMarketingCampaign: boolean };
...
export const ConfigureMarketingAdAccountsDocument = gql`
    mutation ConfigureMarketingAdAccounts($connectedAccountId: UUID!, $customerIds: [String!]!, $managerCustomerId: String) {
  configureMarketingAdAccounts(
    ...
    `;
export type ConfigureMarketingAdAccountsMutationFn = Apollo.MutationFunction<ConfigureMarketingAdAccountsMutation, ConfigureMarketingAdAccountsMutationVariables>;

/**
 * __useConfigureMarketingAdAccountsMutation__
 *
 * To run a mutation, you first call `useConfigureMarketingAdAccountsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useConfigureMarketingAdAccountsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [configureMarketingAdAccountsMutation, { data, loading, error }] = useConfigureMarketingAdAccountsMutation({
 *   variables: {
 *      connectedAccountId: // value for 'connectedAccountId'
 *      customerIds: // value for 'customerIds'
 *      managerCustomerId: // value for 'managerCustomerId'
 *   },
 * });
 */
export function useConfigureMarketingAdAccountsMutation(baseOptions?: Apollo.MutationHookOptions<ConfigureMarketingAdAccountsMutation, ConfigureMarketingAdAccountsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ConfigureMarketingAdAccountsMutation, ConfigureMarketingAdAccountsMutationVariables>(ConfigureMarketingAdAccountsDocument, options);
      }
export type ConfigureMarketingAdAccountsMutationHookResult = ReturnType<typeof useConfigureMarketingAdAccountsMutation>;
export type ConfigureMarketingAdAccountsMutationResult = Apollo.MutationResult<ConfigureMarketingAdAccountsMutation>;
export type ConfigureMarketingAdAccountsMutationOptions = Apollo.BaseMutationOptions<ConfigureMarketingAdAccountsMutation, ConfigureMarketingAdAccountsMutationVariables>;
export const ConfigureMarketingAnalyticsAccountsDocument = gql`
    mutation ConfigureMarketingAnalyticsAccounts($connectedAccountId: UUID!, $propertyIds: [String!]!) {
  configureMarketingAnalyticsAccounts(
    ...
    `;
export type ConfigureMarketingAnalyticsAccountsMutationFn = Apollo.MutationFunction<ConfigureMarketingAnalyticsAccountsMutation, ConfigureMarketingAnalyticsAccountsMutationVariables>;

/**
 * __useConfigureMarketingAnalyticsAccountsMutation__
 *
 * To run a mutation, you first call `useConfigureMarketingAnalyticsAccountsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useConfigureMarketingAnalyticsAccountsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [configureMarketingAnalyticsAccountsMutation, { data, loading, error }] = useConfigureMarketingAnalyticsAccountsMutation({
 *   variables: {
 *      connectedAccountId: // value for 'connectedAccountId'
 ...
 * });
 */
export function useConfigureMarketingAnalyticsAccountsMutation(baseOptions?: Apollo.MutationHookOptions<ConfigureMarketingAnalyticsAccountsMutation, ConfigureMarketingAnalyticsAccountsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ConfigureMarketingAnalyticsAccountsMutation, ConfigureMarketingAnalyticsAccountsMutationVariables>(ConfigureMarketingAnalyticsAccountsDocument, options);
      }
export type ConfigureMarketingAnalyticsAccountsMutationHookResult = ReturnType<typeof useConfigureMarketingAnalyticsAccountsMutation>;
export type ConfigureMarketingAnalyticsAccountsMutationResult = Apollo.MutationResult<ConfigureMarketingAnalyticsAccountsMutation>;
export type ConfigureMarketingAnalyticsAccountsMutationOptions = Apollo.BaseMutationOptions<ConfigureMarketingAnalyticsAccountsMutation, ConfigureMarketingAnalyticsAccountsMutationVariables>;
export const GetMarketingAdAccountsDocument = gql`
...
/**
 * __useGetMarketingAdAccountsQuery__
 *
 * To run a query within a React component, call `useGetMarketingAdAccountsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMarketingAdAccountsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMarketingAdAccountsQuery({
 *   variables: {
 *      connectedAccountId: // value for 'connectedAccountId'
 *   },
 * });
 */
export function useGetMarketingAdAccountsQuery(baseOptions: Apollo.QueryHookOptions<GetMarketingAdAccountsQuery, GetMarketingAdAccountsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMarketingAdAccountsQuery, GetMarketingAdAccountsQueryVariables>(GetMarketingAdAccountsDocument, options);
      }
export function useGetMarketingAdAccountsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMarketingAdAccountsQuery, GetMarketingAdAccountsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMarketingAdAccountsQuery, GetMarketingAdAccountsQueryVariables>(GetMarketingAdAccountsDocument, options);
        }
export type GetMarketingAdAccountsQueryHookResult = ReturnType<typeof useGetMarketingAdAccountsQuery>;
export type GetMarketingAdAccountsLazyQueryHookResult = ReturnType<typeof useGetMarketingAdAccountsLazyQuery>;
export type GetMarketingAdAccountsQueryResult = Apollo.QueryResult<GetMarketingAdAccountsQuery, GetMarketingAdAccountsQueryVariables>;
export const GetMarketingAnalyticsAccountsDocument = gql`
...
/**
 * __useGetMarketingAnalyticsAccountsQuery__
 *
 * To run a query within a React component, call `useGetMarketingAnalyticsAccountsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMarketingAnalyticsAccountsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMarketingAnalyticsAccountsQuery({
 *   variables: {
 *      connectedAccountId: // value for 'connectedAccountId'
 *   },
 * });
 */
export function useGetMarketingAnalyticsAccountsQuery(baseOptions: Apollo.QueryHookOptions<GetMarketingAnalyticsAccountsQuery, GetMarketingAnalyticsAccountsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMarketingAnalyticsAccountsQuery, GetMarketingAnalyticsAccountsQueryVariables>(GetMarketingAnalyticsAccountsDocument, options);
      }
export function useGetMarketingAnalyticsAccountsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMarketingAnalyticsAccountsQuery, GetMarketingAnalyticsAccountsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMarketingAnalyticsAccountsQuery, GetMarketingAnalyticsAccountsQueryVariables>(GetMarketingAnalyticsAccountsDocument, options);
        }
export type GetMarketingAnalyticsAccountsQueryHookResult = ReturnType<typeof useGetMarketingAnalyticsAccountsQuery>;
export type GetMarketingAnalyticsAccountsLazyQueryHookResult = ReturnType<typeof useGetMarketingAnalyticsAccountsLazyQuery>;
export type GetMarketingAnalyticsAccountsQueryResult = Apollo.QueryResult<GetMarketingAnalyticsAccountsQuery, GetMarketingAnalyticsAccountsQueryVariables>;
export const GetMarketingCampaignsDocument = gql`
    query GetMarketingCampaigns($connectedAccountId: UUID!, $customerId: String!, $managerCustomerId: String) {
...
/**
 * __useGetMarketingCampaignsQuery__
 *
 * To run a query within a React component, call `useGetMarketingCampaignsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMarketingCampaignsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMarketingCampaignsQuery({
 *   variables: {
 *      connectedAccountId: // value for 'connectedAccountId'
 ...
 * });
 */
export function useGetMarketingCampaignsQuery(baseOptions: Apollo.QueryHookOptions<GetMarketingCampaignsQuery, GetMarketingCampaignsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMarketingCampaignsQuery, GetMarketingCampaignsQueryVariables>(GetMarketingCampaignsDocument, options);
      }
export function useGetMarketingCampaignsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMarketingCampaignsQuery, GetMarketingCampaignsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMarketingCampaignsQuery, GetMarketingCampaignsQueryVariables>(GetMarketingCampaignsDocument, options);
        }
export type GetMarketingCampaignsQueryHookResult = ReturnType<typeof useGetMarketingCampaignsQuery>;
export type GetMarketingCampaignsLazyQueryHookResult = ReturnType<typeof useGetMarketingCampaignsLazyQuery>;
export type GetMarketingCampaignsQueryResult = Apollo.QueryResult<GetMarketingCampaignsQuery, GetMarketingCampaignsQueryVariables>;
export const PauseMarketingCampaignDocument = gql`
    mutation PauseMarketingCampaign($connectedAccountId: UUID!, $customerId: String!, $campaignId: String!, $managerCustomerId: String) {
  pauseMarketingCampaign(
    ...
    `;
export type PauseMarketingCampaignMutationFn = Apollo.MutationFunction<PauseMarketingCampaignMutation, PauseMarketingCampaignMutationVariables>;

/**
 * __usePauseMarketingCampaignMutation__
 *
 * To run a mutation, you first call `usePauseMarketingCampaignMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePauseMarketingCampaignMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [pauseMarketingCampaignMutation, { data, loading, error }] = usePauseMarketingCampaignMutation({
 *   variables: {
 *      connectedAccountId: // value for 'connectedAccountId'
 *      customerId: // value for 'customerId'
 ...
 * });
 */
export function usePauseMarketingCampaignMutation(baseOptions?: Apollo.MutationHookOptions<PauseMarketingCampaignMutation, PauseMarketingCampaignMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PauseMarketingCampaignMutation, PauseMarketingCampaignMutationVariables>(PauseMarketingCampaignDocument, options);
      }
export type PauseMarketingCampaignMutationHookResult = ReturnType<typeof usePauseMarketingCampaignMutation>;
export type PauseMarketingCampaignMutationResult = Apollo.MutationResult<PauseMarketingCampaignMutation>;
export type PauseMarketingCampaignMutationOptions = Apollo.BaseMutationOptions<PauseMarketingCampaignMutation, PauseMarketingCampaignMutationVariables>;
export const ActivateMarketingCampaignDocument = gql`
    mutation ActivateMarketingCampaign($connectedAccountId: UUID!, $customerId: String!, $campaignId: String!, $managerCustomerId: String) {
  activateMarketingCampaign(
    ...
    `;
export type ActivateMarketingCampaignMutationFn = Apollo.MutationFunction<ActivateMarketingCampaignMutation, ActivateMarketingCampaignMutationVariables>;

/**
 * __useActivateMarketingCampaignMutation__
 *
 * To run a mutation, you first call `useActivateMarketingCampaignMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useActivateMarketingCampaignMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [activateMarketingCampaignMutation, { data, loading, error }] = useActivateMarketingCampaignMutation({
 *   variables: {
 *      connectedAccountId: // value for 'connectedAccountId'
 *      customerId: // value for 'customerId'
 *      campaignId: // value for 'campaignId'
 ...
 * });
 */
export function useActivateMarketingCampaignMutation(baseOptions?: Apollo.MutationHookOptions<ActivateMarketingCampaignMutation, ActivateMarketingCampaignMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ActivateMarketingCampaignMutation, ActivateMarketingCampaignMutationVariables>(ActivateMarketingCampaignDocument, options);
      }
export type ActivateMarketingCampaignMutationHookResult = ReturnType<typeof useActivateMarketingCampaignMutation>;
export type ActivateMarketingCampaignMutationResult = Apollo.MutationResult<ActivateMarketingCampaignMutation>;
export type ActivateMarketingCampaignMutationOptions = Apollo.BaseMutationOptions<ActivateMarketingCampaignMutation, ActivateMarketingCampaignMutationVariables>;
